...
//    @Value("${spring.kafka.listener.poll-timeout}")
 //   private long pollTimeout;
    ...
    public ConsumerFactory<String, String> myConsumerFactory() {
        String groupId = "unique-group-id-" + UUID.randomUUID();
        Map<String, Object> propsMap = new HashMap<>(16);
        propsMap.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        propsMap.put(ConsumerConfig.GROUP_ID_CONFIG, "xx");
    ...
    @Bean
    public ConsumerFactory<String, String> myConsumerFactory2() {
        String groupId = "unique-group-id-" + UUID.randomUUID();
        Map<String, Object> propsMap = new HashMap<>(16);
        propsMap.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        propsMap.put(ConsumerConfig.GROUP_ID_CONFIG, "xx");
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, String>> myListenerContainerFactory2() {
        ConcurrentKafkaListenerContainerFactory<String, String> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(myConsumerFactory2());
        //在侦听器容器中运行的线程数，一般设置为 机器数*分区数
        //  factory.setConcurrency(concurrency);
        //消费监听接口监听的主题不存在时，默认会报错，所以设置为false忽略错误
        // factory.setMissingTopicsFatal(false);
