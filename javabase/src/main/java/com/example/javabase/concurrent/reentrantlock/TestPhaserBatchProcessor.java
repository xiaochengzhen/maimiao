 ...
 * @date 2023/4/7 13:20
 */
public class TestPhaserBatchProcessor {
    ...
    public TestPhaserBatchProcessor(List<String> data, int batchSize, int threadCount) {
        this.data = data;
    ...
    private class BatchProcessor implements Runnable {
     ...
     public static void main(String[] args) {
        //数据准备
         ...
         int batchSize = 4;
         int threadCount = 3;
         TestPhaserBatchProcessor processor = new TestPhaserBatchProcessor(data, batchSize, threadCount);
         //处理数据
         processor.process();
     }
}
