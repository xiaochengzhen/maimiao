...
@NoArgsConstructor
@Data
public class CompanyUsIncomeStatementDTO {
    ...
    public static class DataDTO {
        ...
        public static class ListDTO {
            ...
            @JSONField(name = "us_ext_msg")
            private List<UsExtMsgDTO> usExtMsg;
            ...
            @NoArgsConstructor
            @Data
            public static class UsExtMsgDTO {
                @JSONField(name = "finance_period")
                private String financePeriod;
                @JSONField(name = "periodendingdate_format")
                private String periodendingdateFormat;
                @JSONField(name = "periodendingdate_flag")
                private String periodendingdateFlag;
            }
        }
